...
export const ordersColumns = [
    columnHelper.accessor("scripName", {
        header: "Scrips",
    }),
    ...
    columnHelper.accessor("transactionType", {
        ...
        cell: (info) => {
            ...
            return (
                <span
                    className={`px-4 py-2 mr-2  rounded-md font-inter font-semibold text-[10px] leading-none tracking-normal text-xs uppercase shadow-sm ${isRejected
                            ? "bg-[#E8F2EE] text-[#198055] border border-green-200"
                            : "bg-[#FAEBE9] text-[#CA5321] border border-red-200"
                        }`}
                >
                    {isRejected ? "Bought" : "Sold"}
                </span>
            );
        },
    }),
    ...
    columnHelper.accessor("retentionType", {
        header: "Validity",
    }),
    ...
    columnHelper.accessor("orderedTime", {
        ...
        cell: (info) => {
            ...
            return (
                <span className="font-inter font-[400px] text-[14px] leading-none">
